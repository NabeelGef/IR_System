...
processing.preprocess_input_file('C:/Users/Nabeel/.ir_datasets/wikIR1k/documents.csv',
                                 'C:/Users/Nabeel/.ir_datasets/wikIR1k/clean2.csv')
'''

reader = Read_file()
print("========= Now IN READ FILE ==========")
documents , df =reader.read_file("C:/Users/Nabeel/.ir_datasets/wikIR1k/clean2.csv")
...
evaluation.Qalc(corpus, posting_list, documents, "C:/Users/Nabeel/.ir_datasets/wikIR1k/test/qrels.csv",df)
